...
<div class="auto-style23">
  <div class="divt" align="center"> AGREGAR NUEVO PROVEEDOR</div><br /><br />
  ...
  error_reporting(0);
    ...
    //if(isset($_POST["agregarfac"]))$agregarfac=$_POST["agregarfac"];
    //if(isset($_GET["eliminar"]))$eliminar=$_GET["eliminar"];

    //$select1="SELECT * FROM proveedores";
    ...
    $select2="SELECT nit, empresa, direccion, ciudad, telefono, email, producto FROM proveedores WHERE nit = '$nit' OR empresa = '$empresa' OR producto = '$producto' ";
   ...
   if($agregar1){
     ...
     $sqlinsert0 = "INSERT into proveedores (nit, empresa, direccion, ciudad, telefono, email, producto) VALUES ('$nit', '$empresa', '$direccion', '$ciudad', '$telefono', '$email', '$producto')";
     ...
     echo "<script>alert('¡Nuevo Proveedor Registrado!');
     window.location='/proyecto2/agregarproveedor.php'</script>";
  ...
  <div>
    <form class="form" method="post">
      ...
      <label class="label1">NIT:</label>&nbsp;&nbsp;
      <?php echo "<input class='input1' type='text' name='nit' value='$row2[nit]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label class="label1">Empresa:</label>
      <?php echo "<input class='input1' type='text' name='empresa' value='$row2[empresa]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label class="label1">Dirección:</label>
      <?php echo "<input class='input1' type='text' name='direccion' value='$row2[direccion]'>"; ?><br /><br />
      <label class="label1">Ciudad:</label>
      <?php echo "<input class='input1' type='text' name='ciudad' value='$row2[ciudad]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label class="label1">Telefono:</label>
      <?php echo "<input class='input1' type='text' name='telefono' value='$row2[telefono]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label class="label1">Email:</label>
      <?php echo "<input class='input1' type='text' name='email' value='$row2[email]'>"; ?><br /><br />
      <label class="label1">Producto:</label>&nbsp;
      <?php echo "<input class='input1' type='text' name='producto' value='$row[producto]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

      <input name="consultar" type="submit" value="Consultar" class="btn btn-dark" class="boton1">&nbsp;&nbsp;
      <input name="agregar1" type="submit" value="Agregar Proveedor" class="btn btn-dark" class="boton1">&nbsp;&nbsp;
