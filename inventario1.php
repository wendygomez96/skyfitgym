...
<div class="auto-style23">
  <div class="divt" align="center"> INVENTARIOS (Productos, Maquinaria o equipos, Consolidado)</div><br /><br />


  <form class="form">
    <input name="productos" type="button" value="Productos" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/inventarioproductos.php'"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input name="equipos" type="button" value="Maquinaria y equipos" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/inventarioequipos.php'">
    <br /><br /><br />
    <img border="3" src="imagenesprueba/productos.jpg"  class="auto-style30"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <img border="3" src="imagenesprueba/maquinaria.png" class="auto-style30"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
