...
<div class="auto-style23">
  ...
  if($editar){
    ...
    $sql2="UPDATE rutinasprogramadas SET nombres='$nombres', apellidos='$apellidos', instructor='$instructor', actividad='$actividad', fecha='$fecha', horainicio='$horainicio', horafinal='$horafinal' WHERE identificacion='$identificacion' ";
    $result2 = mysqli_query($conexion,$sql2);
    echo "<script>alert('¡Rutina Actualizada Correctamente!');
    window.location='/proyecto2/programarrutinas.php'</script>";
  }
  if($eliminar){
    $identificacion =$_POST['identificacion'];

    $sql3="DELETE FROM rutinasprogramadas where identificacion = '$identificacion'";
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td><a class='btn btn-danger' href="programarrutinas.php?identificacion=<?php //echo $row['identificacion']?>">Eliminar</a></td><?php //} ?>
        </tr>
      </tbody>
    </table>
<input name='agregarfac' type='submit' value='Agregar Factura' class='btn btn-dark' class='boton1'>
</div>--></div>
