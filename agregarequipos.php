...
<div class="auto-style23">
  <div class="divt" align="center"> Agregar Facturas de Compra Maquinas y Equipos</div><br /><br />
  ...
  error_reporting(0);
    ...
    $select1="SELECT * FROM borrarequipos";
    ...
    $select2="SELECT codigo, equipo, proveedor, costo, mantenimiento, stock FROM inventarioequipos WHERE codigo = '$codigo' OR equipo = '$equipo' OR proveedor = '$proveedor' ";
   ...
   if($agregar1){
     ...
     $sqlinsert0 = "INSERT into borrarequipos (codigo, equipo, unidades, proveedor, costounidad, fecha) VALUES ('$codigo', '$equipo', '$unidades', '$proveedor', '$costo', '$fecha')";
     $result0 = mysqli_query($conexion,$sqlinsert0);

     $sqlinsert1 = "INSERT into agregarequipos (codigo, equipo, unidades, proveedor, costounidad, fecha) VALUES ('$codigo', '$equipo', '$unidades', '$proveedor', '$costo', '$fecha')";
     $sqlinsert2 = "INSERT into inventarioequipos (codigo, equipo, proveedor, costo, mantenimiento, stock) VALUES ('$codigo', '$equipo', '$proveedor', '$costo', '$fecha', '$unidades')";
     $sqlupdate="UPDATE inventarioequipos SET equipo='$equipo', stock='$unidades', proveedor='$proveedor', costo='$costo', mantenimiento='$fecha' WHERE codigo='$codigo' ";
   ...
   if(isset($_GET['codigo'])){
     ...
     $delete="DELETE FROM borrarequipos WHERE codigo= '$codigo'";
     $res3 = mysqli_query($conexion,$delete);
     $delete2="DELETE FROM agregarequipos WHERE codigo= '$codigo'";
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="historial" type="button" value="Historial de Compras" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/historialequipos.php'"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div>
    <form class="form" method="post">
      ...
      <label class="label1">Equipo:</label>&nbsp;&nbsp;&nbsp;&nbsp;
      <?php echo "<input class='input1' type='text' name='equipo' value='$row2[equipo]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label class="label1">Unidades:</label> &nbsp;
      <?php echo "<input class='input1' type='text' name='unidades' value='$row2[stock]'>"; ?><br /><br />
      ...
      <?php echo "<input class='input1' type='text' name='costo' value='$row2[costo]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label class="label1">Fecha:</label>
      <?php echo "<input class='input1' type='date' name='fecha' value='$row[mantenimiento]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <br/>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $row1['equipo'] ?> </td>
      <td><?php echo $row1['proveedor'] ?></td>
      <td><?php echo $row1['costounidad'] ?></td>
      <td><?php echo $row1['unidades'] ?></td>
      <td><?php echo $row1['fecha'] ?> </td>
      <td><a class='btn btn-danger' href="agregarequipos.php?codigo=<?php echo $row1['codigo']?>">Eliminar</a></td><?php } ?>
