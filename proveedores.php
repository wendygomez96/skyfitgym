...
<div class="auto-style23">
  <div class="divt" align="center"> PROVEEDORES </div><br /><br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="consultar" type="button" value="Consultar Proveedor" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/consultarproveedor.php'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="agregar" type="button" value="Agregar Proveedor" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/agregarproveedor.php'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table align="center" class="auto-style38">
            ...
            <td class="auto-style39">
                <div class="div6">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><?php echo $row['nit'] ?></th>
                        <td><?php echo $row['empresa'] ?> </td>
                        <td><?php echo $row['direccion'] ?></td>
                        <td><?php echo $row['ciudad'] ?></td>
                        <td><?php echo $row['telefono'] ?></td>
                        <td><?php echo $row['email'] ?></td>
                        <td><?php echo $row['producto'] ?> <?php } ?></td>
                      </tr>
                    </tbody>
                  </table> </table></div>
                    <br />
