...
<div class="auto-style23">
  <div class="divt" align="center"> Maquinas y Equipos Consultar, actualizar, eliminar</div><br />
  ...
  error_reporting(0);
    ...
    $sql="SELECT codigo, equipo, proveedor, costo, mantenimiento, stock, imagen FROM inventarioequipos WHERE codigo = '$codigo' OR equipo = '$equipo' OR proveedor = '$proveedor' ";
   ...
   if($editar){
     ...
     //$imagen = "../imagenesprueba/".$_FILES['imagen']['name'];

     $sql2="UPDATE inventarioequipos SET equipo='$equipo', proveedor='$proveedor', costo='$costo', mantenimiento='$mantenimiento', stock='$stock', imagen='$imagen' WHERE codigo='$codigo' ";
     $result2 = mysqli_query($conexion,$sql2);
     echo "<script>alert('¡Equipo Actualizado Correctamente!');
     window.location='/proyecto2/consultarequipos.php'</script>";
   }
   if($eliminar){
     $codigo =$_POST['codigo'];

     $sql3="DELETE FROM inventarioequipos where codigo = '$codigo'";
     $result3 = mysqli_query($conexion,$sql3);

     echo "<script>alert('¡Equipo Eliminado!');
     window.location='/proyecto2/consultarequipos.php'</script>";
   }
  ?>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <form method="post"class="form" enctype="multipart/form-data">
    ...
    <label class="label1">Maquina o Equipo:</label>&nbsp;&nbsp;
    <?php echo "<input class='input1' type='text' name='equipo' value='$row[equipo]'>"; ?><br/> <br /><br />
    ...
    <label class="label1">Mantenimiento:</label>
    <?php echo "<input class='input1' type='text' name='mantenimiento' value='$row[mantenimiento]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
