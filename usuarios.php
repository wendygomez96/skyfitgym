...
<div class="auto-style23">
  ...
  error_reporting(0);
    ...
    if(isset($_GET["consultar"]))$consultar=$_GET["consultar"];
    ...
    $sql="SELECT identificacion, nombres, apellidos, correo, contrasena, confirmecontrasena FROM registro WHERE identificacion = '$identificacion' OR nombres = '$nombres' OR apellidos = '$apellidos' ";
   ...
   if($editar){
     ...
     $sql2="UPDATE registro SET nombres='$nombres', apellidos='$apellidos', correo='$correo', contrasena='$contrasena' WHERE identificacion='$identificacion' ";
   ...
   if($eliminar){
     ...
     $sql3="DELETE FROM registro where identificacion = '$identificacion'";
  ...
  <form class="form">
    ...
    <?php echo "<input class='input1' type='text' name='nombres' value='$row[nombres]'>"; ?><br/> <br /><br />
    <label class="label1">Apellidos:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <?php echo "<input class='input1' type='text' name='apellidos' value='$row[apellidos]'>"; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="label1">Correo:</label>
    <?php echo "<input class='input1' type='text' name='correo' value='$row[correo]'>"; ?><br/> <br /><br />
    <label class="label1">Contraseña:</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <?php echo "<input class='input1' type='text' name='contrasena' value='$row[contrasena]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <br/><br /><br />
