...
<div class="auto-style23">
  <div class="divt" align="center"> CONSULTA LAS RUTINAS PROGRAMADAS</div><br />
  ...
  error_reporting(0);
    ...
    $sql="SELECT * FROM rutinasprogramadas";
    ...
    $sql="SELECT identificacion, nombres, apellidos, instructor, actividad, fecha, horainicio, horafinal FROM rutinasprogramadas WHERE identificacion = '$identificacion' OR nombres = '$nombres' OR apellidos = '$apellidos' OR instructor = '$instructor' OR fecha = '$fecha'";
    $result = mysqli_query($conexion,$sql);
  ...
  if(isset($_GET['identificacion'])){
    ...
    $delete="DELETE FROM rutinasprogramadas WHERE identificacion= '$identificacion'";
    $res3 = mysqli_query($conexion,$delete);

    echo "<script>alert('Registro Eliminado');
    window.location='/proyecto2/rutinasprogramadas.php'</script>";
  }
  ?>
  ...
  <form class="form-group" method="post">
    ...
    <?php echo "<input class='input1' type='text' name='apellidos' value='$row1[apellidos]'>"; ?><br/><br/>
    <label class="label1">Instructor:</label>
    <?php echo "<input class='input1' type='text' name='instructor' value='$row1[instructor]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="label1">Fecha:</label>
    <?php echo "<input class='input1' type='date' name='fecha' value='$row1[fecha]'>"; ?>
    <!--<label class="label1">Actividad:</label>
    <?php// echo "<input class='input1' type='text' name='actividad' value='$row1[actividad]'>"; ?><br/><br/>

    <label class="label1">Hora Inicio:</label>
    <?php //echo "<input class='input1' type='time' name='horainicio' value='$row1[horainicio]'>"; ?>
    <label class="label1">Hora Final:</label>
    <?php // echo "<input class='input1' type='time' name='horafinal' value='$row1[horafinal]'>"; ?>
    <br/><br />-->
    &nbsp;&nbsp;&nbsp;
              ...
              <div class="div6">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><a class='btn btn-danger' href="rutinasprogramadas.php?identificacion=<?php echo $row['identificacion']?>">Eliminar</a></td><?php } ?>
                    </tr>
                  </tbody>
                </table> </table>
