...
<div class="auto-style23">
  <div class="divt" align="center"> PROVEEDOR Consultar, actualizar, eliminar</div><br />
  ...
  error_reporting(0);
    ...
    $sql="SELECT nit, empresa, direccion, ciudad, telefono, email, producto FROM proveedores WHERE nit = '$nit' OR empresa = '$empresa' OR producto = '$producto' ";
   ...
   if($editar){
     ...
     $email =$_POST['email'];
     $producto = $_FILES['producto'];

     $sql2="UPDATE proveedores SET empresa='$empresa', direccion='$direccion', ciudad='$ciudad', telefono='$telefono', email='$email', producto='$producto' WHERE nit='$nit' ";
     $result2 = mysqli_query($conexion,$sql2);
     echo "<script>alert('¡Proveedor Actualizado Correctamente!');
     window.location='/proyecto2/consultarproveedor.php'</script>";
   }
   if($eliminar){
     $nit =$_POST['nit'];

     $sql3="DELETE FROM proveedores where nit = '$nit'";
  ...
  <form method="post"class="form-group">
    ...
    <?php echo "<input class='input1' type='text' name='nit' value='$row[nit]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="label1">Empresa:</label>
    <?php echo "<input class='input1' type='text' name='empresa' value='$row[empresa]'>"; ?><br/> <br /><br />
    <label class="label1">Direccion:</label>
    <?php echo "<input class='input1' type='text' name='direccion' value='$row[direccion]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="label1">Ciudad:</label>
    <?php echo "<input class='input1' type='text' name='ciudad' value='$row[ciudad]'>"; ?><br/> <br /><br />
    <label class="label1">Telefono:</label>
    <?php echo "<input class='input1' type='text' name='telefono' value='$row[telefono]'>"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="label1">Email:</label>
    <?php echo "<input class='input1' type='text' name='email' value='$row[email]'>"; ?><br/> <br /><br />
