...
<div class="auto-style23">
  <div class="divt" align="center"> DATOS Y PLANES</div><br /><br />
  ...
  if($editar){
    ...
    $apellidos =$_POST['apellidos'];
    $plan =$_POST['plan'];
    $costoplan =$_POST['costoplan'];
    $fechainicio =$_POST['fechainicio'];
    $fechafinal =$_POST['fechafinal'];

    $sql2="UPDATE rutinasplanes SET nombres='$nombres', apellidos='$apellidos', plan='$plan', costoplan='$costoplan', fechainicio='$fechainicio', fechafinal='$fechafinal' WHERE identificacion='$identificacion' ";
    $result2 = mysqli_query($conexion,$sql2);
    echo "<script>alert('¡Datos y Planes Actualizados Correctamente!');
    window.location='/proyecto2/datosyplanes.php'</script>";
  }
  if($eliminar){
    $identificacion =$_POST['identificacion'];

    $sql3="DELETE FROM rutinasplanes where identificacion = '$identificacion'";
    $result3 = mysqli_query($conexion,$sql3);

    echo "<script>alert('¡Rutina Eliminada!');
    window.location='/proyecto2/datosyplanes.php'</script>";
  }
  ...
  if($agregar){
    ...
    $sql4="INSERT INTO rutinasplanes (identificacion, nombres, apellidos, plan, costoplan, fechainicio, fechafinal) VALUES ('$identificacion', '$nombres', '$apellidos', '$plan', '$costoplan', '$fechainicio', '$fechafinal')";
    $result4 = mysqli_query($conexion,$sql4);
    echo "<script>alert('¡Datos y Planes Agregados Correctamente!');
    window.location='/proyecto2/datosyplanes.php'</script>";
  }
  ?>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="planes" type="button" value="Consultar Planes" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/rutinas.php'"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <form class="form-group" method="post">
    ...
    <label class="label1">Costo del Plan:</label>
    <?php echo "<input class='input1' type='text' name='costoplan' value='$row[costoplan]'>"; ?>
    <label class="label1">Fecha Inicio:</label>
    <?php echo "<input class='input1' type='date' name='fechainicio' value='$row[fechainicio]'>"; ?>
    <label class="label1">Fecha Final:</label>
    <?php echo "<input class='input1' type='date' name='fechafinal' value='$row[fechafinal]'>"; ?><br/><br/>
