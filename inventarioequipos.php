...
<div class="auto-style23">
  <div class="divt" align="center"> MAQUINAS Y EQUIPOS </div><br /><br />

  <?php
  include('conexion.php');

    $sql="SELECT * FROM inventarioequipos" ;
    $result = mysqli_query($conexion,$sql);

  ?>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="consultar" type="button" value="Consultar Stock" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/consultarequipos.php'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="agregar" type="button" value="Agregar Compra" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/agregarequipos.php'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="div6">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Maquina o Equipo</th>
