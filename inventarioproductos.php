...
<div class="auto-style23">
  <div class="divt" align="center"> PRODUCTOS </div><br /><br />

  <?php
  include('conexion.php');

    $sql="SELECT * FROM inventarioproductos" ;
    $result = mysqli_query($conexion,$sql);

  ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="consultar" type="button" value="Consultar Stock" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/consultarproductos.php'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="agregar" type="button" value="Agregar Compra" class="btn btn-success" class="boton1" onClick="location.href='/proyecto2/agregarproductos.php'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
